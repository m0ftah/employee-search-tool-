...
class ApplicationAcceptedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('app.application_accepted_subject', ['title' => $job->title]))
            ->greeting(__('app.hello') . ' ' . $notifiable->name . '!')
            ->line(__('app.application_accepted_intro', ['title' => $job->title]))
            ...
            ->line(__('app.application_accepted_closing'));
    }
